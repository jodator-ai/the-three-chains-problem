...
| Admin panel | [http://localhost:3000](http://localhost:3000) | [http://localhost:3200](http://localhost:3200) | [http://localhost:3400](http://localhost:3400) |
| User panel | [http://localhost:3001](http://localhost:3001) | [http://localhost:3201](http://localhost:3201) | [http://localhost:3401](http://localhost:3401) |
| Block explorer | [http://localhost:3010](http://localhost:3010) | [http://localhost:3210](http://localhost:3210) | [http://localhost:3410](http://localhost:3410) |
